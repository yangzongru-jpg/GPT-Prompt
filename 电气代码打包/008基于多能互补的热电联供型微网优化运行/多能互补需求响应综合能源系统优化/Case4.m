...
%%功率平衡
for k=1:24
constraints=[constraints,P(1,k)+MT(1,k)-Pnas(1,k)+Pnas(2,k)+Pgrid(1,k)+Pwind(1,k)==load(k)+L5(1,k)+L6(1,k)+L7(1,k)];
end
%%热平衡
for i=1:24
...
hold on
bar(PP1','stack');
plot(x,value(load+L5+L6+L7-P),'r','linewidth',2);
