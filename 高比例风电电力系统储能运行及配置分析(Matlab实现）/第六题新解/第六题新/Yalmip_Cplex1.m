function [Result,Cost,PDE,PWind,S_Bat,Bat_limit,P_Bat,Pdis,Pcha] = Yalmip_Cplex1(Load,Wind,mpc,tan,wind,Bat)
%% 初始定义
yalmip clear; % 循环加速
yalmip;
T = 96; %调度周期
...
for t = 1:T
    ...
    % 功率平衡
    St = [St,-0.1 <= P_DE1(t) + P_DE2(t) + P_Wind(t) + P_Bat(t) - Load(t) <= 0.1];
end
%% 目标
Object = 0; % 总成本
F = 0; Tan = 0; % 煤耗及碳排放成本
